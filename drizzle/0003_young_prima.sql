...
ALTER TYPE "public"."order_status" ADD VALUE 'assigned' BEFORE 'completed';--> statement-breakpoint
...
ALTER TABLE "coupons" ALTER COLUMN "used_count" SET DEFAULT '0';--> statement-breakpoint
...
CREATE INDEX "tips_partner_id_idx" ON "tips" USING btree ("partner_id");